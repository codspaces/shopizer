...
public class ProductApiV2 {
	...
	@Operation(httpMethod = "GET", summary = "Get a product by friendlyUrl (slug) version 2", description = "For shop purpose. Specifying ?merchant is "
	...
	@Operation(httpMethod = "GET", summary = "Get a product by sku", description = "For Shop purpose. Specifying ?merchant is required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Single product found", response = ReadableProduct.class) })
	@ResponseBody
	@Parameters({ @Parameter(name = "store", defaultValue = "DEFAULT"),

...
public class ProductApi {
	...
	@Parameters({ @Parameter(name = "store", defaultValue = "DEFAULT"),
			@Parameter(name = "lang", defaultValue = "en") })
	@Operation(httpMethod = "PUT", summary = "Update product", description = "")
	...
	@Operation(httpMethod = "PATCH", summary = "Update product inventory", description = "Updates product inventory")
	@Parameters({ @Parameter(name = "store", defaultValue = "DEFAULT"),
			@Parameter(name = "lang", defaultValue = "en") })
	public void update(
	...
	**/
	...
	@Operation(httpMethod = "GET", summary = "Get a product by friendlyUrl (slug)", description = "For administration and shop purpose. Specifying ?merchant is "
			+ "required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Single product found", response = ReadableProduct.class) })
	@ResponseBody
	@Parameters({ @Parameter(name = "store", defaultValue = "DEFAULT"),
			@Parameter(name = "lang", defaultValue = "en") })
	...
	@Parameters({ @Parameter(name = "store", defaultValue = "DEFAULT") })
	@Operation(httpMethod = "GET", summary = "Check if product code already exists", description = "")
	...
	@Parameters({ @Parameter(name = "store", defaultValue = "DEFAULT"),
			@Parameter(name = "lang", defaultValue = "en") })
	@Operation(httpMethod = "POST", summary = "Patch product sort order", description = "Change product sortOrder")

...
@Tag(tags = {"Catalog management resource (Catalog Management Api)"})
...
public class CatalogApi {
  ...
  @Operation(httpMethod = "GET", summary = "Get catalogs by merchant", description = "")
  @Parameters({
  ...
  @Operation(httpMethod = "GET", summary = "Check if catalog code already exists", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(httpMethod = "POST", summary = "Create catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(httpMethod = "PATCH", summary = "Update catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(httpMethod = "GET", summary = "Get catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
  ...
  @Operation(httpMethod = "DELETE", summary = "Deletes a catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(httpMethod = "POST", summary = "Add catalog entry to catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(httpMethod = "DELETE", summary = "Remove catalog entry from catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(httpMethod = "GET", summary = "Get catalog entry by catalog", description = "")
  @Parameters({
      @Parameter(name = "store", defaultValue = "DEFAULT"),
      @Parameter(name = "lang", defaultValue = "en")})
